...
*/
__HOST_DEVICE__ const double TacsGaussQuadPts1[] = {0.0};
__HOST_DEVICE__ const double TacsGaussQuadWts1[] = {2.0};

__HOST_DEVICE__ const double TacsGaussQuadPts2[] = {-0.577350269189626, 0.577350269189626};
__HOST_DEVICE__ const double TacsGaussQuadWts2[] = {1.0, 1.0};

__HOST_DEVICE__ const double TacsGaussQuadPts3[] = {-0.774596669241483, 0.0, 0.774596669241483};
__HOST_DEVICE__ const double TacsGaussQuadWts3[] = {5.0 / 9.0, 8.0 / 9.0, 5.0 / 9.0};

__HOST_DEVICE__ const double TacsGaussQuadPts4[] = {-0.861136311594053, -0.339981043584856,
                                    0.339981043584856, 0.861136311594053};
__HOST_DEVICE__ const double TacsGaussQuadWts4[] = {0.347854845137454, 0.652145154862546,
                                    0.652145154862546, 0.347854845137454};

__HOST_DEVICE__ const double TacsGaussQuadPts5[] = {-0.906179845938664, -0.538469310105683, 0.0,
                                    0.538469310105683, 0.906179845938664};
__HOST_DEVICE__ const double TacsGaussQuadWts5[] = {0.236926885056189, 0.478628670499366,
                                    0.568888888888889, 0.478628670499366,
                                    0.236926885056189};

__HOST_DEVICE__ const double TacsGaussQuadPts6[] = {
...
__HOST_DEVICE__ const double TacsGaussQuadWts6[] = {
...
__HOST_DEVICE__ const double TacsGaussQuadPts7[] = {
...
__HOST_DEVICE__ const double TacsGaussQuadWts7[] = {
...
__HOST_DEVICE__ const double TacsGaussQuadPts8[] = {
...
__HOST_DEVICE__ const double TacsGaussQuadWts8[] = {
...
*/
__HOST_DEVICE__ const double TacsGaussLobattoPts2[] = {-1.0, 1.0};
__HOST_DEVICE__ const double TacsGaussLobattoWts2[] = {1.0, 1.0};

__HOST_DEVICE__ const double TacsGaussLobattoPts3[] = {-1.0, 0.0, 1.0};
__HOST_DEVICE__ const double TacsGaussLobattoWts3[] = {1.0 / 3.0, 4.0 / 3.0, 1.0 / 3.0};

__HOST_DEVICE__ const double TacsGaussLobattoPts4[] = {-1.0, -0.44721359549995793,
                                       0.44721359549995793, 1.0};
__HOST_DEVICE__ const double TacsGaussLobattoWts4[] = {1.0 / 6.0, 5.0 / 6.0, 5.0 / 6.0,
                                       1.0 / 6.0};

__HOST_DEVICE__ const double TacsGaussLobattoPts5[] = {-1.0, -0.65465367070797709, 0.0,
                                       0.65465367070797709, 1.0};
__HOST_DEVICE__ const double TacsGaussLobattoWts5[] = {1.0 / 10.0, 49.0 / 90.0, 32.0 / 45.0,
                                       49.0 / 90.0, 1.0 / 10.0};

__HOST_DEVICE__ const double TacsGaussLobattoPts6[] = {-1.0,
                                       -0.76505532392946474,
                                       -0.2852315164806451,
                                       0.2852315164806451,
                                       0.76505532392946474,
                                       1.0};
__HOST_DEVICE__ const double TacsGaussLobattoWts6[] = {1.0 / 15.0,          0.378474956297847,
